                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form" action="{{ route('admin.questions.update', [$question]) }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 offset-1">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <textarea rows="10" class="form-control" placeholder="Start Typing Here ..." id="editor" name="question">{{ $question->question }}</textarea>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <select class="form-select" name="answer" required>
                                                                <option selected value="" disabled>Click Here
                                                                </option>
                                                                @forelse ($answers as $item)
                                                                    <option value="{{ $item->choice }}"
                                                                        selected="@php if($item->choice == $question->answer){
                                                                        echo 'true';
                                                                    }else{
                                                                       echo 'false';
                                                                    } @endphp">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column"
                                                                ...
                                                                value="{{ $question->answer_resource }}">
                                                        </div>
                                                        @error('answer_resource')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <textarea rows="10" class="form-control" placeholder="Start Typing Here ..." id="editor1"
                                                        name="short_answer">{{ $question->short_answer }}</textarea>
                                                    <div id="informationchar"></div>
                                                    <div id="informationword"></div>
                                                    {{-- <div id="informationparagraphs"></div> --}}
                                                    @error('short_answer')
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <textarea rows="10" class="form-control" placeholder="Start Typing Here ..." id="editor2"
                                                        name="full_answer">{{ $question->full_answer }}</textarea>
                                                    <div id="informationchar"></div>
                                                    {{-- <div id="informationword"></div> --}}
                                                    <div id="informationparagraphs"></div>
                                                    @error('full_answer')
