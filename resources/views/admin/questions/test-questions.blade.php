                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ $test->name }} : Create Question</h4>
                            </div>
                                                ...
                                                <div class="col-md-12 col-12">
                                                    ...
                                                    <fieldset class="form-group">
                                                        <select class="form-select dynamicSubjectDomain"
                                                            ...
                                                            data-dependent="topic_id" data-campaign="sender-name"
                                                            required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column"
                                                                class="form-control" placeholder="A Answer" name="A">
                                                        </div>
                                                        @error('choice_A')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column"
                                                                class="form-control" placeholder="B Answer" name="B">
                                                        </div>
                                                        @error('choice_B')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column"
                                                                class="form-control" placeholder="C Answer" name="C">
                                                        </div>
                                                        @error('choice_C')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column"
                                                                class="form-control" placeholder="D Answer" name="D">
                                                        </div>
                                                        @error('choice_D')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column"
                                                                class="form-control" placeholder="E Answer" name="E">
                                                        </div>
                                                        @error('choice_E')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
